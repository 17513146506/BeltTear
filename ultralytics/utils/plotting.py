...
class Annotator:
    ...
    def box_label(self, box, label="", color=(0, 0, 255), txt_color=(255, 255, 255), rotated=False):
        """
    ...
    def masks(self, masks, colors, im_gpu, alpha=0.5, retina_masks=False):
        ...
        colors = torch.tensor([[0, 255, 0] for _ in range(len(masks))], device=masks.device,
